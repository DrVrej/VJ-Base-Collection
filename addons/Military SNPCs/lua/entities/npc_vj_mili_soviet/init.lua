...
-----------------------------------------------*/
ENT.Model = {"models/soviet/soviet_soldier1.mdl", "models/soviet/soviet_soldier2.mdl", "models/soviet/soviet_soldier3.mdl", "models/soviet/soviet_soldier4.mdl", "models/soviet/soviet_soldier5.mdl", "models/soviet/soviet_soldier6.mdl"}
ENT.StartHealth = 60
...
ENT.SoundTbl_GrenadeSight = {"vj_military/russian/grenade1.wav", "vj_military/russian/grenade2.wav", "vj_military/russian/grenade3.wav", "vj_military/russian/grenade4.wav", "vj_military/russian/grenade5.wav", "vj_military/russian/grenade6.wav"}
