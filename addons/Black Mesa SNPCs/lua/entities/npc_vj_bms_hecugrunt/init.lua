...
function ENT:HandleGibOnDeath(dmginfo, hitgroup)
	...
	self:CreateGibEntity("prop_ragdoll", "models/gibs/humans/marines/torso.mdl", {Pos=self:LocalToWorld(Vector()), Ang=self:GetAngles(), Vel=self:GetRight()*math.Rand(-100, 100)+self:GetForward()*math.Rand(-100, 100)})
	self:CreateGibEntity("prop_ragdoll", "models/gibs/humans/marines/right_leg.mdl", {Pos=self:LocalToWorld(Vector()), Ang=self:GetAngles(), Vel=self:GetRight()*math.Rand(100, 250)+self:GetForward()*math.Rand(-300, 300)})
	self:CreateGibEntity("prop_ragdoll", "models/gibs/humans/marines/left_leg.mdl", {Pos=self:LocalToWorld(Vector()), Ang=self:GetAngles(), Vel=self:GetRight()*math.Rand(-100, -250)+self:GetForward()*math.Rand(-300, 300)})
