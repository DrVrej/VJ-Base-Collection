...
ENT.SoundTbl_GrenadeSight = {"vj_bms_securityguard/nade1.wav", "vj_bms_securityguard/nade2.wav", "vj_bms_securityguard/nade3.wav", "vj_bms_securityguard/nade4.wav", "vj_bms_securityguard/nade5.wav", "vj_bms_securityguard/nade6.wav"}
...
function ENT:HandleGibOnDeath(dmginfo, hitgroup)
	...
	self:CreateGibEntity("prop_ragdoll", "models/gibs/humans/guard/torso.mdl", {Pos=self:LocalToWorld(Vector()), Ang=self:GetAngles(), Vel=self:GetRight()*math.Rand(-100, 100)+self:GetForward()*math.Rand(-100, 100)})
	self:CreateGibEntity("prop_ragdoll", "models/gibs/humans/guard/right_leg.mdl", {Pos=self:LocalToWorld(Vector()), Ang=self:GetAngles(), Vel=self:GetRight()*math.Rand(100, 250)+self:GetForward()*math.Rand(-300, 300)})
