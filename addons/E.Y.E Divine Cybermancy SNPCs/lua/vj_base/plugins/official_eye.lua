...
--------------------------------------------------*/
VJ.AddPlugin("E.Y.E: Divine Cybermancy SNPCs", "NPC")
...
VJ.AddNPC("Turtle Egg", "sent_vj_eye_turtle_egg", spawnCategory)
VJ.AddNPC("Random Animal", "sent_vj_eye_rand_animal", spawnCategory)